...
export default function ReviewsSection() {
    ...
    // Como os cards são largos, duas vezes costuma ser suficiente para o loop.
    ...
    return (
        <section className="py-24 bg-white overflow-hidden">
            ...
            {/* Container do Carrossel com máscara de gradiente lateral */}
            <div className="relative flex overflow-x-hidden">
                ...
                <div className="flex animate-marquee hover:[animation-play-state:paused] gap-8 py-4 w-max">
                    {scrollReviews.map((review, index) => (
                        <div
                            key={`${review.id}-${index}`}
                            className="w-[320px] md:w-[450px] flex-shrink-0 bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm transition-all duration-500 flex flex-col justify-between
                                       hover:scale-[1.02] hover:border-red-400 hover:shadow-[0_0_30px_rgba(255,0,0,0.15)] cursor-default"
                        >
                            <div>
