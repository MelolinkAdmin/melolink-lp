...
export function WhatsAppButton() {
  const comercialChannel = contactsDataJson.channels.find(
    ...
    const message = encodeURIComponent("Olá! Vim do site.");
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center justify-end group">
      ...
      <a
        ...
        className="flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg shadow-[#25D366]/40 hover:scale-110 transition-transform duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#25D366]"
      >
        <svg
